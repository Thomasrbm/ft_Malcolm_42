...
def _get_ips(af_family=socket.AF_UNSPEC):
    ...
    for msg in results:
        ...
        if local_address is not None:
            ...
            ips.setdefault(interface_idx, list()).append(data)
    return ips
...
def _get_if_list():
    ...
    for msg in results:
        ...
        if ifname is not None:
            if interface_idx in lifips:
                ips = lifips[interface_idx]
